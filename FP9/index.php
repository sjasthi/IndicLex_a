...
<main>
    <section class="hero-section text-center d-flex align-items-center">
        <div class="container">
            ...
            <a href="#dict-catalog" class="btn btn-primary btn-lg mt-4">Explore Dictionaries</a>
            <a href="reports.php" class="btn btn-primary btn-lg mt-4">View IndicLex Report</a>
        </div>
    </section>
</main>
