...
<body
	...
	<thead>
        ...
        <tr>
			...
			<td>    
				<a href="dictionary.php?edit=<?php echo $row['dict_id'] ?>"class="btn btn-sm btn-info">Edit</a>
				<a href="entry_manager.php?dict=<?php echo $row['dict_id'] ?>" class="btn btn-sm btn-warning">Manage</a>
				<a href="validate.php?dict=<?php echo $row['dict_id'] ?>" class="btn btn-sm btn-warning">Validate</a>
				<a href="dictionary.php?delete=<?php echo $row['dict_id'] ?>" class="btn btn-sm btn-danger">Delete</a>
			</td>
        </tr>
        <?php endwhile; ?>
	</tbody>
