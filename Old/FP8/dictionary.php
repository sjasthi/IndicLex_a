...
<body
	...
	<thead>
        ...
        <tr>
			...
			<td>    
				<a href= "dictionary.php?edit=<?php echo $row['dict_id'] ?>"class="btn btn-info">Edit</a>
				<a href="entry_manager.php?dict=<?php echo $row['dict_id'] ?>" class="btn btn-warning">Manage Entries</a>
				<a href="dictionary.php?delete=<?php echo $row['dict_id'] ?>" class="btn btn-danger">Delete</a>
			</td>
        </tr>
        <?php endwhile; ?>
	</tbody>
